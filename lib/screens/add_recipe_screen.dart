            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  Text('${recipe.ingredients.length} Ingredients', style: TextStyle(fontWeight: FontWeight.bold, color: theme.colorScheme.secondary)),
                  const SizedBox(height: 4),
                  Text(recipe.ingredients.take(3).join(', ') + (recipe.ingredients.length > 3 ? '...' : ''), style: theme.textTheme.bodyMedium),

                  const SizedBox(height: 16),
                  Text('Instructions', style: TextStyle(fontWeight: FontWeight.bold, color: theme.colorScheme.secondary)),
                  const SizedBox(height: 4),
